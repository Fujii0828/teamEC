...
import com.internousdev.maple.util.CommonUtility;
...
public class ResetPasswordConfirmAction extends ActionSupport implements SessionAware{
	...
	public String getConcealedPasword() {
		return concealedPassword;
	}

	public void setConcealedPasword(String concealedPasword) {
		this.concealedPassword = concealedPasword;
	}
